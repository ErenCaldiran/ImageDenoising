...
class AutoEncoder(nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.ConvTranspose2d(in_channels=50,
                                           out_channels=20,
                                           kernel_size=5,
                                           stride=1,
                                           padding=1,)
        self.conv4 = nn.ConvTranspose2d(in_channels=20,
                                        out_channels=10,
                                        kernel_size=5,
                                        stride=2,
                                        padding=1,)
                                        
        self.conv5 = nn.ConvTranspose2d(in_channels=10,
                                        out_channels=1,
                                        kernel_size=5,
                                        stride=2,
                                        padding=1,
...
def train():
    ...
    for img, _ in train_loader:  # next batch
        ...
        psnr = peak_signal_noise_ratio(img_ndarr,output_ndarr,data_range=1)
